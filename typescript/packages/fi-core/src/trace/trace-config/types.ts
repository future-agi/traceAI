 ...
 *     envKey: FI_HIDE_INPUTS, // "FI_HIDE_INPUTS"
 *     type: "boolean",
 *   }
 * }
 * ```
...
/**
 * A callback that is called when a new active {@link FISpan} is created
 */
export type FIActiveSpanCallback = (span: FISpan) => void;