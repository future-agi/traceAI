...
// Helper functions
/**
 * Adds message attributes to the span following FI conventions
...
/**
 * Handles tool calls within a message using FI semantic conventions
...
/**
 * Handles tool results within a message using FI semantic conventions
 ...
 * Processes text, image, and other content types with appropriate FI attributes
 *
 ...
 * Processes message array and sets FI input message attributes with proper indexing
 *
 * @param params Object containing extraction parameters
 * @param params.span The OpenTelemetry span to set attributes on
