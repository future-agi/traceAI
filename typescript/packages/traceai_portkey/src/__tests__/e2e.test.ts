 ...
 *
 * These tests run against the Portkey AI Gateway and export spans
 ...
 *
 * Run with: FI_API_KEY=... PORTKEY_API_KEY=... pnpm test -- --testPathPattern=e2e
 */
...
const describeE2E = FI_API_KEY && PORTKEY_API_KEY ? describe : describe.skip;
...
describeE2E("Portkey E2E Tests", () => {
  ...
  beforeAll(async () => {
    ...
    client = new Portkey({ apiKey: PORTKEY_API_KEY });
  });
