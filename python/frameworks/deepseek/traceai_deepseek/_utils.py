...
def is_deepseek_client(instance: Any) -> bool:
    """Check if the OpenAI client is configured for DeepSeek."""
    try:
        ...
        if base_url is not None:
            ...
            return any(url in base_url_str for url in DEEPSEEK_BASE_URLS)
    except Exception:
        pass
    return False
