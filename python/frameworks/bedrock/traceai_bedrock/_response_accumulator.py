...
from traceai_bedrock._trace_collector import (
    TraceCollector,
    TraceNode,
    TraceSpan,
)
...
class _Attributes:
    ...
    def __init__(
        ...
        span_kind: FiSpanKindValues = FiSpanKindValues.LLM,
    ) -> None:
        """
        ...
        self.span_kind: FiSpanKindValues = span_kind
...
class _ResponseAccumulator:
    ...
    def _create_spans(self, parent_span: Span, trace_node: TraceNode) -> None:
        ...
        for trace_span in trace_node.spans:
            ...
            if isinstance(trace_span, TraceNode):
                attributes.span_kind = FiSpanKindValues.CHAIN
                if trace_span.node_type == "agent-collaborator":
                    attributes.span_kind = FiSpanKindValues.AGENT
    ...
    def _process_model_invocation_input(
        ...
        attributes.name = "LLM"
        attributes.span_kind = FiSpanKindValues.LLM
    ...
    def _process_invocation_input(cls, event_data: Dict[str, Any], attributes: _Attributes) -> None:
        ...
        if "agentCollaboratorInvocationInput" in invocation_input:
            ...
            attributes.span_kind = FiSpanKindValues.TOOL
