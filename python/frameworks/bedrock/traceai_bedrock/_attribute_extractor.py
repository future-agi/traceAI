...
from traceai_bedrock.utils.json_utils import (
...
class AttributeExtractor:
    ...
    def get_attributes_from_model_invocation_input(
        ...
        # Set attributes
        return {
            **get_llm_attributes(**llm_attributes, provider=FiLLMProviderValues.AWS),  # type: ignore
    ...
    def get_attributes_from_code_interpreter_input(
        ...
        return {
            ...
            **get_span_kind_attributes(FiSpanKindValues.TOOL),
    ...
    def get_attributes_from_knowledge_base_lookup_input(
        ...
        return {
            ...
            **get_span_kind_attributes(FiSpanKindValues.RETRIEVER),
            **{"metadata": metadata},
        }
    ...
    def get_attributes_from_agent_collaborator_invocation_input(
        ...
        return {
            **get_span_kind_attributes(FiSpanKindValues.AGENT),
    ...
    def get_document_attributes(cls, index: int, ref: Dict[str, Any]) -> Dict[str, Any]:
        ...
        The attributes are formatted according to FI semantic conventions.
        ...
        Note:
            The method follows FI semantic conventions for document attributes
    ...
    def extract_bedrock_retrieve_input_attributes(cls, kwargs: dict[str, Any]) -> dict[str, Any]:
        ...
        Note:
            The method follows FI semantic conventions and sets the span
            kind to RETRIEVER to properly categorize the operation in traces.
        """
        input_text = kwargs.get("retrievalQuery", {}).get("text", "")
        return {
            **get_input_attributes(input_text, mime_type=FiMimeTypeValues.TEXT),
            **get_span_kind_attributes(FiSpanKindValues.RETRIEVER),
            **get_llm_invocation_parameter_attributes(
    ...
    def extract_bedrock_retrieve_response_attributes(
        ...
        Returns:
            Dict[str, Any]: A dictionary of OpenTelemetry attributes containing
                          ...
                          according to FI semantic conventions.
